...
| Campo | Valor |
| --- | --- |
| Document owner | Engineering governance / Control owners |
| Domain | Enterprise repository control governance |
| Lifecycle status | ACTIVE |
| Authoritative source role | Fuente de verdad operativa viva para el estado vigente de controles enterprise |
| Effective date | 2026-07-11 |
| Last verified date | 2026-07-11 |
| Review cadence | Mensual y ante cambios materiales de controles |
| Supersedes | None |
| Superseded by | None |
| Related controls or gaps | Enterprise control set; current update: ERM-OWN-001, ERM-CTRL-008 and ERM-CTRL-009 |
| Evidence or approval reference | PR #1440; canary PRs #1441 through #1444; enterprise CODEOWNERS enforcement closeout |
...
| ERM-CTRL-008 | Code and Operational Ownership | Code Ownership Governance | IMPLEMENTED | 3 | NONE | Tech lead / Domain owners | [baseline](../audit/enterprise-repository-maturity-baseline.md); [historical gap register](../audit/enterprise-repository-gap-register.md); [ownership model](./ownership-model.md); [CODEOWNERS](../../.github/CODEOWNERS); [implementation closeout](../implementation/enterprise-codeowners-enforcement-closeout.md); [audit closeout](../audit/enterprise-codeowners-enforcement-closeout-audit.md) | Path-based CODEOWNERS is present in `main`; required code-owner review is enabled; one approval is required; stale approvals are dismissed; administrators are enforced; and representative canaries #1441 through #1444 automatically requested `VETNEB` while remaining `REVIEW_REQUIRED`. `ERM-OWN-001` closure criteria were satisfied on 2026-07-11. | NONE | 2026-07-11 | Trimestral y ante cambios de ownership o enforcement | Preserve the current CODEOWNERS mapping and branch-protection enforcement; revalidate after changes to paths, collaborators, CODEOWNERS or protection settings. Specialist-team separation and ownership metrics remain optional maturity improvements. | Remains implemented while protected paths retain effective code-owner routing, required approval enforcement and verifiable review behavior. |
| ERM-CTRL-009 | Code and Operational Ownership | CODEOWNERS Domain Model | IMPLEMENTED | 3 | NONE | Tech lead / Domain owners | [baseline](../audit/enterprise-repository-maturity-baseline.md); [historical gap register](../audit/enterprise-repository-gap-register.md); [ownership model](./ownership-model.md); [CODEOWNERS](../../.github/CODEOWNERS); [implementation closeout](../implementation/enterprise-codeowners-enforcement-closeout.md); [audit closeout](../audit/enterprise-codeowners-enforcement-closeout-audit.md) | PR #1440 established the incremental path model. Canary PRs #1441, #1442, #1443 and #1444 demonstrated automatic reviewer assignment for `.github/**`, `docs/**`, `server/**` and `frontend/**`; each requested `VETNEB`, remained `REVIEW_REQUIRED`, completed applicable checks successfully and was closed without merge. `ERM-OWN-001` was operationally closed on 2026-07-11. | NONE | 2026-07-11 | Trimestral y ante cambios de CODEOWNERS | Preserve representative path coverage and repeat targeted canaries after material ownership-model or protection changes. | Remains implemented while GitHub automatically requests a valid code owner for representative protected path changes and required review enforcement remains active. |
