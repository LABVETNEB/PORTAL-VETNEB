...
presente; #1602 y #1603 demostraron las rutas docs-only y backend. `ERM-CI-001` queda cerrado
operativamente desde 2026-07-12 sin reescribir el gap register histórico; branch protection
continúa exigiendo solo los dos contextos globales.
...
ya están presentes en todos los PR hacia `main`, con heavy condicional y propagación fail-closed.
