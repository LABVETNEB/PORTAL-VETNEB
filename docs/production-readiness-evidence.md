...
| P0-016 | Backup | P0 | **Pendiente — sin evidencia formal** | Backup DB Supabase y Storage: pendiente de verificacion manual en dashboard. No existe evidencia verificada en repo ni logs. Checklist de cierre en `docs/ops/BACKUP_RESTORE_ROLLBACK.md` secciones 6 y 7. | Ejecutar backup desde panel Supabase + registrar evidencia sanitizada (fecha UTC, estado, tamano aproximado, responsable tecnico) en seccion 15 del runbook | Backup verificado con evidencia sanitizada formal registrada en runbook |
