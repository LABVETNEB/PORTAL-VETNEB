...
| P0-016 | Backup | P0 | **Parcialmente mitigado — dump externo DB ejecutado 2026-06-08. Backup automatico NO disponible (Free plan). Restore drill y Storage export siguen pendientes.** | Dump externo ejecutado con pg_dump/pg_dumpall v17.10 el 2026-06-08T07:45:48Z fuera del repo. Archivos en `C:\VETNEB-BACKUPS`. Evidencia sanitizada (tamanos, SHA-256) en `docs/ops/BACKUP_RESTORE_ROLLBACK.md` seccion 18. Sin secretos ni dumps en repo. Backup automatico no disponible por Free plan. Storage export pendiente. | Dump ejecutado y evidencia registrada en runbook. Pendiente: (1) cifrado/vault del dump, (2) restore drill (P0-017), (3) Storage export. | P0 cierra completamente cuando: dump cifrado/vault OK + restore drill ejecutado (P0-017) + Storage export ejecutado. |
