# Enterprise CODEOWNERS Domain Model — Implementation Record
...
| Authoritative source role | Implementation evidence |
...
This document is implementation evidence. It is not a normative ownership source and does not replace `.github/CODEOWNERS`, `docs/governance/ownership-model.md`, `docs/governance/enterprise-control-register.md`, or `docs/SOURCES_OF_TRUTH.md`.
