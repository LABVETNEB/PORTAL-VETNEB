...
Select-String -LiteralPath 'test\study-tracking-suite-completeness.test.ts','test\reports-suite-completeness.test.ts','test\storage-suite-completeness.test.ts','test\security-critical-route-surface-registry.test.ts','test\security-boundary-suite-completeness.test.ts' -Pattern '<legacy fastify basenames>|assertFileExists|readSource|existsSync|path:' -Context 1,1
