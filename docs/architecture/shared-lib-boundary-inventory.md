...
| `lib/public-pricing-cache.ts` (54) | Pricing | infrastructure (cache) | — | Bajo | `features/pricing/infrastructure/` | M18 | movido byte-idéntico (M18 mergeado — PR #1519, squash `5f99b5f…`, 2026-07-21); path legacy conservado como shim temporal hasta M19 |
...
| Pricing | `db-pricing.ts` + `lib/public-pricing-cache.ts` | infra | `features/pricing/infrastructure/` | infrastructure | M18 | precedente Logistics | serialización pricing | infra guard (nuevo: `pricing-infrastructure-boundary-guard`) | sí (shims temporales hasta M19) | revert | Bajo | MOVE (mergeado — PR #1519, squash `5f99b5f…`, 2026-07-21; paths legacy = shims) |
