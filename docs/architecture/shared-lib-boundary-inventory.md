...
| `lib/public-pricing-cache.ts` (54) | Pricing | infrastructure (cache) | — | Bajo | `features/pricing/infrastructure/` | M18 | movido byte-idéntico (M18 mergeado — PR #1519, squash `5f99b5f…`, 2026-07-21); **shim legacy retirado en M19** (rutas thin vía servicio directo; path legacy eliminado, cero consumidores operativos) |
