...
// and teardown.
// - CI serves the production bundle already generated by the workflow.
...
const applicationServerCommand = isCi
...
// CI-only by construction — local dev never runs the production bundle.
