...
export const E2E_SUITE_CATALOG = [
  ...
  entry("e2e/regression/dashboard-zero-scroll-baseline.spec.ts", "regression", "dashboard", "zero-scroll baseline 21x13", [], extended, { criticality: "P1", fixture: "admin-populated-api-server", evidence: "test-results", notes: "A08: app-shell zero-scroll freeze over the SAME canonical A02 matrix (21 surfaces x 13 viewports = 273 combinations); documentElement/body/main.dashboard-main must not scroll and main must not be an operational scroll container. Contracted internal canvas scroll stays permitted (audit §10)." }),
