...
export const E2E_SUITE_CATALOG = [
  ...
  entry("e2e/clinic/shell/dashboard-clinic-full-route-stage-parity.spec.ts", "clinic", "shell", "CMP-06 full-route module stage parity", ["public-clinic"], ci, { fixture: "admin-populated-api-server", notes: "CMP-06: 5 clinic full routes × 6 canonical phone viewports compare the complete stage/workspace/viewport/module-card frame against live Admin runtime." }),
  entry("e2e/clinic/shell/dashboard-clinic-metric-run-parity.spec.ts", "clinic", "shell", "CMP-05 canonical metric run parity", ["public-clinic"], ci, { fixture: "admin-populated-api-server", notes: "CMP-05: 10 clinic surfaces × 6 canonical phone viewports verify the one inline ModuleMetricRun implementation." }),
  ...
  entry("e2e/clinic/shell/dashboard-clinic-module-card-parity.spec.ts", "clinic", "shell", "CMP-04 canonical module card parity", ["public-clinic"], ci, { fixture: "admin-populated-api-server", notes: "CMP-04: 5 clinic root modules × 6 canonical phone viewports verify the shared ModuleCard geometry and zero page overflow." }),
  ...
  entry("e2e/particular/auth/particular-authenticated-zoom-sentinel.spec.ts", "particular", "auth", "authenticated zoom sentinel", ["public-clinic"], ci, { criticality: "P1", fixture: "particular-session-contracts", notes: "Sentinel required: desktop short-height 1536x696 con report=null/reception, marketing oculto, logout alcanzable y cero clipping contra el ancestro recortador." }),
