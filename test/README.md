...
| `frontend-e2e-smoke` | Fast Playwright smoke for auth, public routes, hydration, theme and dashboard foundation. | `frontend-ci` (conditional, non-required) | `frontend` | `pnpm --dir frontend e2e:taxonomy-required` | `frontend/e2e/**`<br>`frontend/src/**` | `conditional` |
