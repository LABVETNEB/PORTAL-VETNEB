// Logistics · infrastructure (repositorio de persistencia)
//
// Implementación canónica de la persistencia del contexto Logistics (M12). El
// archivo se movió completo desde `server/db-logistics.ts` sin reorganizar
// funciones ni reparticionar transacciones: sólo cambian los specifiers de
// import exigidos por la nueva profundidad. `server/db-logistics.ts` queda como
// shim de compatibilidad mientras las rutas legacy siguen en
// `server/routes/logistics-*.fastify.ts` (hasta M14–M16).
