...
export const IMPACT_RULES = deepFreeze([
  ...
  {
    id: "workflow-security-validator",
    matcher: { type: "exact", path: "scripts/governance/workflow-security-validator.mjs" },
    impacts: ["workflow-policy", "workflow-security-parser-validation"],
    gates: ["pr-governance", "backend-ci", "manual-review"],
    suiteIds: ["backend-test-typecheck", "backend-tests"],
    description: "Parser-backed workflow security validation affects workflow and CI security governance.",
  },
  {
    id: "workflow-security-validator-types",
    matcher: { type: "exact", path: "scripts/governance/workflow-security-validator.d.mts" },
    impacts: ["workflow-policy", "workflow-security-parser-validation"],
    gates: ["pr-governance", "backend-ci", "manual-review"],
    suiteIds: ["backend-test-typecheck", "backend-tests"],
    description: "Workflow security validator declarations affect typed test contracts for workflow governance.",
  },
  {
    id: "github-workflows",
